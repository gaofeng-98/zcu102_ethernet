...
##############I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART\
1##################SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD\
1#SD 1##########################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {\
##############scl_out#sda_out#scl_out#sda_out#rxd#txd#txd#rxd##################sdio1_data_out[4]#sdio1_data_out[5]#sdio1_data_out[6]#sdio1_data_out[7]#sdio1_bus_pow#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out##########################} \
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {193.678} \
   CONFIG.CLKOUT1_PHASE_ERROR {294.199} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50.000} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {126.625} \
   CONFIG.MMCM_CLKIN1_PERIOD {13.333} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {27.125} \
   CONFIG.MMCM_DIVCLK_DIVIDE {7} \
   CONFIG.PRIM_IN_FREQ {74.999252} \
